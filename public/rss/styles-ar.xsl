...
<!--
  Modern RSS Feed Stylesheet - Arabic Version
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml" lang="ar" dir="rtl">
      <head>
        <title><xsl:value-of select="/rss/channel/title"/> - خلاصة RSS</title>
      ...
      <body>
        <div class="container">
          ...
          <div class="info-banner">
            <strong>📡 هذه خلاصة RSS</strong> - طريقة للاشتراك في التحديثات من هذا الموقع. 
            <strong>اشترك</strong> بنسخ هذا الرابط إلى قارئ RSS المفضل لديك أو تطبيق الأخبار. 
            جديد على RSS؟ <a href="https://aboutfeeds.com" target="_blank">تعلّم المزيد عن الخلاصات ←</a>
          </div>
          ...
          <footer class="footer">
            <p>
              من إنشاء <a href="https://saifabdelrazek.com" target="_blank">سيف عبدالرازق</a> • 
              مدعوم بـ <a href="https://astro.build" target="_blank">Astro</a>
            </p>
          </footer>
        </div>
      </body>
